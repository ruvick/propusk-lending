...
function init() {
  ...
  myGeoObjects[0] = new ymaps.Placemark([51.216117, 36.300894], {
    // Свойства. 
    // hintContent: '<div class="map-hint">Авто профи, Курск, ул.Комарова, 16</div>',
    balloonContent: '<div class="map-hint"> "ГК ЦЕНТР СТРАХОВАНИЯ АВТОПРОФИ", Курская область, Обоянский район, г.Обоянь, ул.Ленина д.98, к.20</div>',
  }, {
